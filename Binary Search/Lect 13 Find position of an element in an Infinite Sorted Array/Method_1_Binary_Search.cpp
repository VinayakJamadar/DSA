...
// 2. while(elem > arr[high]) low = high, high = high * 2
...
int main(){
    ...
    if(ind == -1) cout<<"Element "<<elem<<" is not present in array.";
    else cout<<"Element "<<elem<<" is present at index : "<<ind<<endl;
    return 0;
}